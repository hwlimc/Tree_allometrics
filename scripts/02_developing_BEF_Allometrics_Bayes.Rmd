...
Gamma and lognormal fits use the positive response scale directly. Student fits
saved with `z1`/`z2` use log-transformed responses, so their pointwise
log-likelihoods are Jacobian-adjusted before LOO comparison.
