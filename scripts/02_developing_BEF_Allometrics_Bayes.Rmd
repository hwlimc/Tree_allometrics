...
Model comparison is restricted to gamma fits because the non-gamma fits showed
sampling pathologies. Gamma fits use the positive response scale directly.
