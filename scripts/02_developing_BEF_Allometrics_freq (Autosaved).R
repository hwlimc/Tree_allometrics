...
mod.enf<-nls(befa.st~exp_decay(rsd,L,A,k),bp[bp$PFT=='ENF',],start=c(L=1.3,A=1.4,k=2))
mod.ebf<-nls(befa.st~exp_decay(rsd,L,A,k),bp[bp$PFT=='EBF',],start=c(L=1.3,A=1.4,k=2))
